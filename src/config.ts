...
export const siteConfig: SiteConfig = {
	...
	banner: {
		enable: false,
		src: "/images/AtTheNight.png", // Relative to the /src directory. Relative to the /public directory if it starts with '/'
...
export const profileConfig: ProfileConfig = {
	avatar: "/images/JaychouGreatestWork.png", // Relative to the /src directory. Relative to the /public directory if it starts with '/'
	name: "XianRuiDendro",
